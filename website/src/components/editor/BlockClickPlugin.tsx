 ...
 * this creates a new paragraph after that block and selects it.
 * For non-editable blocks (images, HRs), pressing Enter will also
...
export function BlockClickPlugin() {
  ...
  useEffect(() => {
    ...
    const handleClick = (event: MouseEvent) => {
      ...
      // Must be within editor vertical bounds
      if (clickY < rootRect.top || clickY > rootRect.bottom) return;

      // Must be within editor horizontal bounds
